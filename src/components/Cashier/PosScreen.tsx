            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  value={barcodeInput ? barcodeInput : searchFilter}
                  onChange={(e) => {
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 font-bold border border-emerald-200/80 rounded-xl text-xs flex items-center gap-1.5 transition active:scale-95 cursor-pointer shadow-2xs"
                        ...
                        <div className="relative w-full h-40 sm:h-44 mb-3 rounded-xl overflow-hidden bg-white/90 border border-emerald-100/90 flex items-center justify-center p-3 group-hover:bg-white transition-colors shadow-inner">
                          {prod.imageUrl ? (
                            <img
                              src={prod.imageUrl}
                              alt={prod.name}
                              className="w-full h-full object-contain scale-100 group-hover:scale-105 transition-transform duration-300"
                              onError={(e) => {
          ...
          <div className="bg-white p-5 rounded-2xl border-2 border-slate-300 shadow-md flex flex-col justify-between space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {cart.length > 0 && (
                    <button
                      ...
                      className="p-1 text-rose-700 hover:text-rose-900 transition cursor-pointer"
              ...
              <div className="py-2.5 border-b border-slate-200 grid grid-cols-4 gap-1.5 text-xs">
                {(
                  ...
                  <button
                    ...
                    className={`py-1.5 px-1 rounded-xl text-[11px] font-bold text-center transition truncate border cursor-pointer ${
                      customerType === c.id
                        ? 'bg-emerald-800 text-white border-emerald-900 shadow-sm'
                        : 'bg-slate-100 text-slate-900 border-slate-300 hover:bg-slate-200'
                    }`}
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (customerType === 'anggota') {
                      ...
                      if (found) {
                        setMemberNumber(found.memberNumber);
                      }
                    }
                  }}
                ...
                {cart.length === 0 ? (
                  <div className="py-12 text-center text-slate-800 space-y-2">
                    ...
                    <p className="text-[11px] font-bold text-slate-700">
                      Scan barcode barang atau klik produk dari katalog di atas
                    </p>
                  </div>
                ) : (
                  cart.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-1.5">
                        <button
                          ...
                          className="w-6 h-6 rounded-lg bg-slate-200 border border-slate-400 text-slate-950 flex items-center justify-center hover:bg-slate-300 active:scale-95 font-black cursor-pointer"
                        >
                      ...
                      <div className="text-right min-w-[75px]">
                        ...
                        <button
                          ...
                          className="text-[10px] font-bold text-rose-700 hover:text-rose-950 hover:underline cursor-pointer"
                        >
                          Hapus
                        </button>
                      </div>
            ...
            <div className="pt-3 border-t-2 border-slate-200 space-y-3">
              ...
              {cart.length > 0 && (
                <div className="flex items-center justify-between gap-2">
                  <button
                    ...
                    className="w-full py-1.5 px-2.5 bg-amber-100 hover:bg-amber-200 text-amber-950 font-bold border border-amber-300 rounded-xl text-xs flex items-center justify-center gap-1 transition cursor-pointer"
                  >
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-emerald-700 hover:bg-emerald-800 disabled:opacity-50 text-white font-black rounded-xl shadow-lg transition active:scale-[0.98] flex items-center justify-center space-x-2 text-sm sm:text-base cursor-pointer"
              >
